...
class LeaveMaster extends Component {
  ...
  onSubmitHandler(e) {
    ...
    if (this.state.lpy === "") {
      this.setState({
        status: false,
        error: "Please Enter Leave Permissible in a Yearly",
        showMsg: true,
      });
      return false;
    } else {
    ...
    if (this.state.lpm === "") {
      this.setState({
        status: false,
        error: "Please Enter Leave Permissible in a Month",
        showMsg: true,
      });
      return false;
    } else {
    ...
    return (
      <div>
        {this.state.showMsg ? (
          <div
            className={
              this.state.status ? "alert alert-success" : "alert alert-danger"
            }
            role="alert"
          >
            <button
            ...
            <i className="fa fa-frown-o mr-2" aria-hidden="true"></i>
            {this.state.error}
          </div>
        ) : (
          <div></div>
        ...
        <form onSubmit={this.onSubmitHandler}>
          <div className="form-group">
            ...
            <select
              ...
              data-placeholder="Choose Deapartment"
            >
          ...
          <div className="form-group">
            ...
            <input
              type="number"
              onChange={this.handleChange}
              value={this.state.lpy}
              className="form-control"
              name="lpy"
              placeholder="Leave Permissible Yearly"
            />
          </div>
          <div className="form-group">
            ...
            <input
              type="number"
              onChange={this.handleChange}
              value={this.state.lpm}
              className="form-control"
              name="lpm"
              placeholder="Leave Permissible Monthly"
            />
          </div>
          <div className="form-group">
