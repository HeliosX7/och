...
class fellowshipExtension extends Component {
  ...
  onSubmitHandler(e) {
    ...
    if (this.state.from_date === "") {
      this.setState({
        status: false,
        error: "Please Select fellowship Extension From Date",
        showMsg: true,
      });
      return false;
    } else {
    ...
    if (this.state.to_date === "") {
      this.setState({
        status: false,
        error: "Please Select fellowship Extension To Date",
        showMsg: true,
      });
      return false;
    } else {
    ...
    if (this.state.admn_no === "") {
      this.setState({
        status: false,
        error: "Please Enter Student Admission No",
        showMsg: true,
      });
      return false;
    } else {
    ...
    axios({
      ...
      .then((response) => {
        ...
        if (response.data.status === true) {
          //alert();
          this.setState({
            course: response.data.data.StudentDetails[0].course_id,
            branch: response.data.data.StudentDetails[0].branch_id,
            showMsg: response.data.showMsg,
          });
